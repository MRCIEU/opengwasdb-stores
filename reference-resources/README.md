...
- `hgdp1kgp-hg38-ld/` - HGDP+1kGP LD reference panels for AFR, EAS and SAS (planned). Built from a different, much smaller cohort than the EUR panel; see ADR 0020 for why, and for the resulting permanent difference in completion quality across ancestries.
